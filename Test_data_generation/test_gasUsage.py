...
# The increase in gas per additional element in a list is expected to be linear
# This test is conducted with ganache set to automine meaing there is not block interval time as time is not a factor in this experiment
